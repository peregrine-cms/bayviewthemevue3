...
/*
  ...
  "name": "Sponsorband",
  "componentPath": "bayviewthemevue3/components/sponsorband",
  "package": "com.bayviewthemevue3.models",
  "modelName": "Sponsorband",
...
@Model(
        ...
        resourceType = "bayviewthemevue3/components/sponsorband",
...
//GEN]
public class SponsorbandModel extends AbstractComponent {

    public SponsorbandModel(final Resource r) { super(r); }
	...
	/* {"type":"string","x-source":"inject","x-form-label":"Wide Photo","x-form-type":"pathbrowser","x-form-browserRoot":"/content/bayviewthemevue3/assets"} */
	@Inject
	...
	/* {"type":"object","x-source":"inject","x-form-label":"Sponsors","x-form-type":"collection","x-form-fieldLabel":["name"],"properties":{"name":{"type":"string","x-source":"inject","x-form-label":"Name","x-form-type":"text"},"link":{"type":"string","x-source":"inject","x-form-label":"Link","x-form-type":"text"}}} */
	@Inject
	private List<IComponent> sponsors;
...
//GEN]
	...
	/* {"type":"object","x-source":"inject","x-form-label":"Sponsors","x-form-type":"collection","x-form-fieldLabel":["name"],"properties":{"name":{"type":"string","x-source":"inject","x-form-label":"Name","x-form-type":"text"},"link":{"type":"string","x-source":"inject","x-form-label":"Link","x-form-type":"text"}}} */
	public List<IComponent> getSponsors() {
		return sponsors;
	}
