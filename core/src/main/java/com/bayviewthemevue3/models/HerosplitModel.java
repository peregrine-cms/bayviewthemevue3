...
/*
    ...
    "Herosplit": {
      ...
      "properties": {
        ...
        "logotext": {
          "type": "string",
          "x-source": "inject",
          "x-form-label": "Logo Box Text (words stack per line)",
          "x-form-type": "text"
        },
        "kicker": {
          "type": "string",
          "x-source": "inject",
          "x-form-label": "Kicker (small text, top right)",
          "x-form-type": "text"
        },
        "title": {
          "type": "string",
          "x-source": "inject",
          "x-form-label": "Headline",
          "x-form-type": "text"
        },
        "ctatext": {
          "type": "string",
  ...
  "name": "Herosplit",
  "componentPath": "bayviewthemevue3/components/herosplit",
  "package": "com.bayviewthemevue3.models",
  "modelName": "Herosplit",
...
@Model(
        ...
        resourceType = "bayviewthemevue3/components/herosplit",
...
//GEN]
public class HerosplitModel extends AbstractComponent {

    public HerosplitModel(final Resource r) { super(r); }

    //GEN[:INJECT
    	/* {"type":"string","x-source":"inject","x-form-label":"Hero Image (left)","x-form-type":"pathbrowser","x-form-browserRoot":"/content/bayviewthemevue3/assets"} */
	@Inject
	...
	/* {"type":"string","x-source":"inject","x-form-label":"Logo Box Text (words stack per line)","x-form-type":"text"} */
	@Inject
	private String logotext;

	/* {"type":"string","x-source":"inject","x-form-label":"Kicker (small text, top right)","x-form-type":"text"} */
	@Inject
	private String kicker;

	/* {"type":"string","x-source":"inject","x-form-label":"Headline","x-form-type":"text"} */
	@Inject
	...
	/* {"type":"string","x-source":"inject","x-form-label":"Button Link","x-form-type":"pathbrowser","x-form-browserRoot":"/content"} */
	@Inject
