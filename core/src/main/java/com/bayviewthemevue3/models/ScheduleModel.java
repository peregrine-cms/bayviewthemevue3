...
/*
    ...
    "Schedule": {
      ...
      "properties": {
        ...
        "showinstructor": {
          "type": "string",
          "x-source": "inject",
          "x-form-label": "Show instructor names",
          "x-form-type": "materialswitch"
        },
        "hideempty": {
          "type": "string",
          "x-source": "inject",
          "x-form-label": "Hide days without classes",
          "x-form-type": "materialswitch"
        },
        "visibility": {
          "type": "string",
  ...
  "name": "Schedule",
  "componentPath": "bayviewthemevue3/components/schedule",
  "package": "com.bayviewthemevue3.models",
  "modelName": "Schedule",
...
@Model(
        ...
        resourceType = "bayviewthemevue3/components/schedule",
...
//GEN]
public class ScheduleModel extends AbstractComponent {

    public ScheduleModel(final Resource r) { super(r); }
	...
	/* {"type":"string","x-source":"inject","x-form-label":"Show instructor names","x-form-type":"materialswitch"} */
	@Inject
	private String showinstructor;

	/* {"type":"string","x-source":"inject","x-form-label":"Hide days without classes","x-form-type":"materialswitch"} */
	@Inject
...
//GEN]
	...
	/* {"type":"string","x-source":"inject","x-form-label":"Show instructor names","x-form-type":"materialswitch"} */
	public String getShowinstructor() {
